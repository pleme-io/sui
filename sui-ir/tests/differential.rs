...
/// The hand-authored supplement now lives in `tests/common/mod.rs`, shared
/// with the slice-2 eval differential (`eval_differential.rs`) — one seed
/// list, two proofs (render equality here, result equality there).
mod common;

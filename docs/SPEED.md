...
| **S1** | L1 Fx needed-bindings + L2 path intern; L7 **rec-scope spike** (correctness question only, burden raised per §II) | — (parallel with S0) | A/B Improved or honest Discard rows; spike verdict: rec-member capture sound / restricted | wk 1 |

  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "dynamic-schema" "email-validator" "fast_chemail" "graphiql" "handlebars" "playground" "tempfile" ];
      };
      ...
      "ed25519-dalek" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "digest" "fast" "rand_core" "signature" "std" "zeroize" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.15.0";
      ...
      "gix" = rec {
        ...
        features = {
          ...
          "blocking-http-transport-curl-openssl" = [ "blocking-http-transport-curl" "gix-transport/http-client-curl-openssl" ];
          ...
          "sha1" = [ "gix-hash/sha1" "gix-archive?/sha1" "gix-blame?/sha1" "gix-commitgraph/sha1" "gix-config/sha1" "gix-diff/sha1" "gix-dir?/sha1" "gix-discover/sha1" "gix-filter?/sha1" "gix-hashtable/sha1" "gix-index?/sha1" "gix-merge?/sha1" "gix-negotiate?/sha1" "gix-object/sha1" "gix-odb/sha1" "gix-pack/sha1" "gix-protocol/sha1" "gix-ref/sha1" "gix-refspec/sha1" "gix-revision/sha1" "gix-revwalk/sha1" "gix-shallow/sha1" "gix-status?/sha1" "gix-submodule?/sha1" "gix-traverse/sha1" "gix-worktree?/sha1" "gix-worktree-state?/sha1" "gix-worktree-stream?/sha1" ];
        ...
        resolvedDefaultFeatures = [ "attributes" "blocking-http-transport-reqwest" "blocking-http-transport-reqwest-rust-tls" "blocking-network-client" "command" "credentials" "excludes" "index" "revision" "sha1" "tree-editor" "worktree-mutation" ];
      };
      "gix-actor" = rec {
        crateName = "gix-actor";
        version = "0.40.0";
      ...
      "gix-blame" = rec {
        ...
        features = {
          "sha1" = [ "gix-commitgraph/sha1" "gix-diff/sha1" "gix-hash/sha1" "gix-object/sha1" "gix-revwalk/sha1" "gix-traverse/sha1" "gix-worktree/sha1" ];
        };
        resolvedDefaultFeatures = [ "sha1" ];
      };
      "gix-chunk" = rec {
      ...
      "gix-features" = rec {
        ...
        resolvedDefaultFeatures = [ "crc32" "default" "fs-read-dir" "io-pipe" "once_cell" "prodash" "progress" "walkdir" "zlib" ];
      };
      "gix-filter" = rec {
      ...
      "gix-pack" = rec {
        ...
        resolvedDefaultFeatures = [ "object-cache-dynamic" "sha1" "streaming-input" ];
      };
      "gix-packetline" = rec {
      ...
      "gix-protocol" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking-client" "fetch" "handshake" "sha1" ];
      };
      "gix-quote" = rec {
        crateName = "gix-quote";
        version = "0.7.0";
      ...
      "gix-revision" = rec {
        ...
        resolvedDefaultFeatures = [ "describe" "merge_base" "sha1" ];
      };
      "gix-revwalk" = rec {
      ...
      "gix-shallow" = rec {
        ...
        features = {
          "serde" = [ "dep:serde" "gix-hash/serde" "nonempty/serialize" ];
          "sha1" = [ "gix-hash/sha1" ];
        };
        resolvedDefaultFeatures = [ "sha1" ];
      };
      "gix-status" = rec {
        ...
        resolvedDefaultFeatures = [ "sha1" "worktree-rewrites" ];
      };
      "gix-submodule" = rec {
        ...
        features = {
          "sha1" = [ "gix-config/sha1" "gix-refspec/sha1" ];
        };
        resolvedDefaultFeatures = [ "sha1" ];
      };
      "gix-tempfile" = rec {
      ...
      "gix-transport" = rec {
        ...
        resolvedDefaultFeatures = [ "base64" "blocking-client" "default" "gix-credentials" "http-client" "http-client-reqwest" "http-client-reqwest-rust-tls" "reqwest" ];
      };
      "gix-traverse" = rec {
      ...
      "gix-worktree" = rec {
        ...
        resolvedDefaultFeatures = [ "attributes" "sha1" ];
      };
      "gix-worktree-state" = rec {
        ...
        features = {
          "sha1" = [ "gix-filter/sha1" "gix-index/sha1" "gix-object/sha1" "gix-worktree/sha1" ];
        };
        resolvedDefaultFeatures = [ "sha1" ];
      };
      ...
      "nix-nar" = rec {
        ...
        version = "0.3.1";
        edition = "2021";
        sha256 = "1q6rcbf0chjiz7hgva1f486zwk1lacfw5wazha1l57zqglazmnqm";
        libName = "nix_nar";
        authors = [
          "Alexandru Scvortov <code@scvalex.net>"
        ];
        dependencies = [
          {
            name = "camino";
      ...
      "nonempty" = rec {
        ...
        version = "0.12.0";
        edition = "2021";
        sha256 = "1dpc3xi8bd8dynkh42b0ysv8w4b5hvidmvcqdxrx0p1y6lkf0dwp";
        authors = [
      ...
      "object_store" = rec {
        ...
        resolvedDefaultFeatures = [ "aws" "base64" "cloud" "default" "form_urlencoded" "fs" "http-body-util" "hyper" "md-5" "quick-xml" "rand" "reqwest" "ring" "serde" "serde_json" "serde_urlencoded" "walkdir" ];
      };
      "once_cell" = rec {
        crateName = "once_cell";
        version = "1.21.4";
      ...
      "prodash" = rec {
        ...
        version = "31.0.0";
        edition = "2021";
        sha256 = "0k304x706f6ykvm313hrvad02x432f2wxzfrjw94alfmszi008ln";
        authors = [
          "Sebastian Thiel <sebastian.thiel@icloud.com>"
        ];
        dependencies = [
      ...
      "reqwest 0.12.28" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "charset" "default" "default-tls" "h2" "http2" "json" "rustls-tls" "rustls-tls-native-roots" "rustls-tls-native-roots-no-provider" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" "stream" "system-proxy" ];
      };
      "reqwest 0.13.2" = rec {
        crateName = "reqwest";
        version = "0.13.2";
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-aws-lc-rs" "__tls" "blocking" "charset" "http2" "rustls" ];
      };
      "ring" = rec {
        crateName = "ring";
        version = "0.17.14";
      ...
      "sui-eval" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "gix";
            usesDefaultFeatures = false;
            features = [ "sha1" "blocking-network-client" "blocking-http-transport-reqwest-rust-tls" "worktree-mutation" "revision" "tree-editor" ];
          }
          {
            name = "im-rc";
            packageId = "im-rc";
      ...
      "tsunagu" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        sha256 = "0nqh5xk7yw9nvihh0y6l8c5fj48v3px2khn071w9xgyfza2mmfz3";
        dependencies = [
          {
            name = "dirs";
            packageId = "dirs";
      ...
      "windows-sys 0.52.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Security_Cryptography" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Console" "Win32_System_Diagnostics" "Win32_System_Diagnostics_Debug" "Win32_System_IO" "Win32_System_Threading" "Win32_System_Time" "Win32_System_WindowsProgramming" "default" ];
      };
      "windows-sys 0.59.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Globalization" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Com" "Win32_System_Console" "Win32_System_Memory" "Win32_System_Threading" "Win32_UI" "Win32_UI_Shell" "default" ];
      };
      ...
      "zlib-rs" = rec {
        ...
        resolvedDefaultFeatures = [ "c-allocator" "default" "rust-allocator" "std" ];
      };
      "zmij" = rec {
        crateName = "zmij";
        version = "1.0.21";
